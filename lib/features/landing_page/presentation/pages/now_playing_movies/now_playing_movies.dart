...
class NowPlayingMovies extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    AsyncValue<List<TopMovie>> nowMovies = ref.watch(nowPlayingdMovies);
    return Column(
      ...
      children: [
        ...
        Text('Solo en ITIFlix', textAlign: TextAlign.left, style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white)),
        SizedBox(
          height: 5,
        ),
        Container(
            height: 150,            
            child: nowMovies.when(
                data: (nowMovies) {
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                       ...
                       Config.SIZE_200 + nowMovies[index].posterPath;
                      return Container(
                        width: 100,
                        height: 150,
